...
Exemple : `{idx} - {pretty(title)}.{ext}` → `01 - Je Regarde Vos Vidéos.mkv`""",
    ...
    "audio_only_toggle": "🎧",
    "audio_only_toggle_help": "Choisir entre télécharger la vidéo+audio (défaut) ou l'audio uniquement. La valeur par défaut peut être définie avec la variable d'environnement DEFAULT_MEDIA_TYPE.",
